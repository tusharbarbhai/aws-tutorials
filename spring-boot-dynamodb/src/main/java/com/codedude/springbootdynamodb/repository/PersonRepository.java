package com.codedude.springbootdynamodb.repository;
...
public class PersonRepository {
    ...
    public String updatePerson(Person person) {
        mapper.save(person, buildUpdateExpression(person));
        return "Person Updated";
    }

    private DynamoDBSaveExpression buildUpdateExpression(Person person) {
